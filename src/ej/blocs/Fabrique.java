...
public class Fabrique {
	...
	public static Set<IBloc> creerMur(final int quantite){
		...
		Callable<IBloc> taskMur = ()-> { return new Mur(1, 1, 1, true); }; // utilisation des Virtual Thread pour instancier les blocs tout en gérant la question de la performance.
